...
namespace Dcp.Net.Modules
{
    ...
    public class DcpModuleInfo
    {
        ...
        ///     模块实例
        /// </summary>
        public DcpModule Instance { get; }

        /// <summary>
        ///     依赖的其他模块
        /// </summary>
        public List<DcpModuleInfo> Dependencies { get; }
        ...
        public DcpModuleInfo(Type type, DcpModule instance)
        {
            ...
            Dependencies = new List<DcpModuleInfo>();
        }
